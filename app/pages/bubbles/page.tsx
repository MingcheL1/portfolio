...
const Page = () => {
  return (
    <div className="flex flex-col items-center justify-center text-white font-mono px-4">
      ...
      <h1 className="my-10 text-4xl sm:text-5xl md:text-6xl font-bold font-sans text-center">BubblesCLI Screensaver</h1>
      <p className="text-lg sm:text-xl my-10 break-words max-w-2xl text-center">
        Simple, customizable linux screensaver in the terminal. Written in C++.
      </p>
      <img
        src="/bubblescli.gif"
      ...
      <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-6 mt-5">
        <Link href="https://github.com/MingcheL1/BubblesCLI">
