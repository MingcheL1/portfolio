        ...
        <div>
            <div className="flex flex-col items-center my-10 text-white">
                ...
                <div className="flex space-x-4 mt-14">
                    ...
                    <div className="relative group"><img src="/icons/tailwind.png" className="w-10 h-10 links_anim"/><span className="popup_box">tailwind css</span></div>
                    ...
                    <div className="relative group"><img src="/icons/ue5.png" className="w-8 h-8 links_anim rounded-md"/><span className="popup_box">unreal engine blueprint</span></div>
                </div>
            </div>
        </div>
    )
